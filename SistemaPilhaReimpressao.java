...
public class SistemaPilhaReimpressao {
    public static void main(String[] args) {
        PilhaReimpressao pilha = new PilhaReimpressao(); // Capacidade fixa de 10
        Scanner scanner = new Scanner(System.in);

        while (true) {
            System.out.println("1. Carregar Documentos do Arquivo entrada.txt");
            System.out.println("2. Adicionar Documento para Reimpressao");
            System.out.println("3. Reimprimir Documento");
            ...
            switch (opcao) {
                case 1:
                    carregarDocumentosArquivo(pilha);
                    break;
                ...
                case 2:
                    ...
                    try {
                        pilha.push(nomeArquivo, nomeUsuario, Calendar.getInstance());
                ...
                case 4:
                    ...
                    System.out.println(pilha.consultarDocumento(arquivoConsulta));
                    break;

                case 5:
                    pilha.relatorioPilha();
                    break;
    ...
    private static void carregarDocumentosArquivo(PilhaReimpressao pilha) {
        try {
